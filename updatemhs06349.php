...
<div class="utama">
	...
	<div class="text-center"><a href="lapmhs06349.php"><span class="fas fa-print">&nbsp;Laporan</span></a></div>
	<span class="float-left">
		<a class="btn btn-success" href="addmhs06349.php">Tambah Data</a>
	</span>
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="editmhs06349.php?kode=<?php echo $row['id']?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="hpsmhs06349.php?kode=<?php echo $row["id"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
