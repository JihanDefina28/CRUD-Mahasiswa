...
//jika halaman daftar data barabg dibuka pertamakali, tampilkan data halaman 1 
	if ($_GET['hal']<>0){
		$halAktif=$_GET['hal'];
	}else{
		$halAktif=1;
...
while($row=mysqli_fetch_assoc($hasil)){
	...
	<tr>
		...
		<a class="btn btn-outline-danger btn-sm" href="hpsmhs06349.php?kode=<?php echo $row["id"]?>"onclick="return confirm('Yakin dihapus nih?')">Hapus</a></td>
	</tr>
	<?php 
	$no++;
}
