...
$folderupload ="foto/";
$fileupload = $folderupload . basename($_FILES['foto']['name']); // foto/A12.2020.06349.jpg
$filefoto = basename($_FILES['foto']['name']);                  // A12.2020.06349.jpg
...
// jika semua berjalan lancar
    ...
    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $fileupload)) {        
        //membuat query
		$sql="insert databrg values('','$nim','$nama','$email','$foto')";
		mysqli_query($koneksi,$sql);
		header("location:addmhs06349.php");
