...
<html>
<head>
	<title>Data Mahasiswa :: Edit Data Mahasiswa</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="utama">
		...
		<div class="col-sm-3 text-center">
			...
			<div>
				[ <a href="gantifotomhs06349.php?id=<?php echo $row['id']?>">Ganti Foto</a> ]
			</div>	
		</div>
		<div class="col-sm-9">
			<form enctype="multipart/form-data" method="post" action="sv_editmhs06349.php">
